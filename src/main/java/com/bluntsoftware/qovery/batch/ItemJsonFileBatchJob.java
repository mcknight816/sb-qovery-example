...
@Slf4j
@Component
public class ItemJsonFileBatchJob implements FileBatchJob<Map<String, Object>, Item>, HotFolderListener {
    ...
    public ItemJsonFileBatchJob(ItemRepo repository, StepBuilderFactory stepBuilderFactory, JobLauncher jobLauncher, JobBuilderFactory jobBuilderFactory, HotFolderWatcher hotFolderWatcher) {
        this.repository = repository;
        this.stepBuilderFactory = stepBuilderFactory;
        this.jobLauncher = jobLauncher;
        this.jobBuilderFactory = jobBuilderFactory;
        this.mapper = new ObjectMapper();
        hotFolderWatcher.addListener("batch/item",this);
    }
    ...
    */
    ...
    public void run(File file, int chunkSize) throws JobParametersInvalidException, JobExecutionAlreadyRunningException, JobRestartException, JobInstanceAlreadyCompleteException {
        ...
        var job = jobBuilderFactory
                ...
                .flow(stepBuilderFactory
                        ...
                        .<Map<String, Object>,Item>chunk(chunkSize)
                        .reader(reader(file))
                        .processor(processor())
                        .writer(writer())
                        .build())
    ...
    @Override
    public ItemProcessor<Map<String, Object>, Item> processor() {
        return map -> mapper.convertValue(map,Item.class);
    }
