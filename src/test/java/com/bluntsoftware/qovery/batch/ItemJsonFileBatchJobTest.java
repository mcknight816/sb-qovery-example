...
class ItemJsonFileBatchJobTest {

  ItemJsonFileBatchJob batchJob;
  ...
  void before()  throws IOException {
    ...
    batchJob = new ItemJsonFileBatchJob( repository,  stepBuilderFactory,  jobLauncher,  jobBuilderFactory,hotFolderWatcher);
  }
